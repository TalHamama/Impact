MAIN SCREEN: 
-   realtions for filtering
-   all data and realtions -> for each node: location, name, realtions

SECOND:
 PER NODE:
 -  תעודת זהות
 -  realations and affects
 -  maintenance
 -  reports
 -  LINKS MAP
 ...
 -  All of the relations: The realtions types for filtering 
 -  For Each NODEa + NODEb select name, location and All relations 
 

 ## SECOND
 ### BY Node ID:
 -  SELECT * 
 -  SELECT ALL Realtions Names
 -  Maintenance
 -  A "Links Map" All The Links connected to the Node And All The Links Connected to them
